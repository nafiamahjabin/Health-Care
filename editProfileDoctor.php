...
$s = " select * from tbl_doctor where dr_username = '$username'";

$result = mysqli_query($con, $s);
while($row = mysqli_fetch_array($result))
{
    $firstName= $row['dr_FirstName'];
    $lastName= $row['dr_LastName'];
    $pass= $row['dr_password'];
    $mobile= $row['dr_mobile'];
    $chem= $row['dr_chember'];
    $vH= $row['dr_visitTime'];
    $conN= $row['dr_conName'];
    $email= $row['dr_email'];
    $conM= $row['dr_conMobile'];
    $deg= $row['dr_degree'];
    $fFee= $row['dr_firstFee'];
    $sFee= $row['dr_secondFee'];
    $dept= $row['dr_dept'];
}
 ...
 <div class="container">
   ...
   <form action="updateDoctor.php" method="post">
          <div class="form-group">
            ...
            <div class="form-group">
            <label>Department</label>
            <input type="text" name="dept" class="form-control" value="<?=$dept?>" required>  
            </div>
            <div class="form-group">
            <label>Qualification</label>
            <input type="text" name="deg" class="form-control" value="<?=$deg ?>" required>  
            </div>
            <div class="form-group">
            <label>Chember Address</label>
            <input type="text" name="chem" class="form-control" value="<?=$chem ?>" required>  
            </div>
            <div class="form-group">
            <label>Visiting Hours</label>
            <input type="text" name="vH" class="form-control" value="<?=$vH?>" required>  
            </div>
            <div class="form-group">
            <label>First Visit Fees</label>
            <input type="text" name="fFee" class="form-control" value="<?=$fFee ?>" required>  
            </div>
            <div class="form-group">
            <label>Second Visit Fees</label>
            <input type="text" name="sFee" class="form-control" value="<?=$sFee ?>" required>  
            </div>
            <div class="form-group">
            <label>Ticket Provider's Name</label>
            <input type="text" name="conN" class="form-control" value="<?=$conN?>" required>  
            </div>
            <div class="form-group">
            <label>Publicly Reachable Contact No.</label>
            <input type="text" name="conM" class="form-control" value="<?=$conM ?>" required>  
            </div>
