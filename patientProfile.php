...
$s = "select * from tbl_patient Where pat_username = '$pat_username'";
    ...
    <!---End of Nav bar-->
	 ...
	 <div class="profile-area" >
		...
		<?php if($row = mysqli_fetch_array($result)){ ?>
			...
			<label class="detail"><?=$row['pat_FirstName'].' '.$row['pat_LastName']?></label>
			</div>
            <div class="row">
			<div class="col-md-4">
			</div>  
			<label class="detail">Email: </label>
			<label class="detail"><?=$row['pat_email']?></label>
			</div>
            <div class="row">
			<div class="col-md-4">
			</div>  
			<label class="detail">Mobile No: </label>
			<label class="detail"><?=$row['pat_mobile']?></label>
			</div>
            <div class="row">
			<div class="col-md-4">
			</div>  
			<label class="detail">Username: </label>
			<label class="detail"><?=$row['pat_username']?></label>
			</div>
            <div class="row">
			<div class="col-md-4">
			</div>  
			<label class="detail">Password: </label>
			<label class="detail"><?=$row['pat_password']?></label>
			</div>
            <div class="row">
			<div class="col-md-4">
			</div>  
			<label class="detail">Address: </label>
			<label class="detail"><?=$row['pat_address']?></label>
			</div>
            <div class="row">
			<div class="col-md-4">
			</div>  
			<label class="detail">Birth Date: </label>
			<label class="detail"><?=$row['pat_birthDate']?></label>
			</div>
            <div class="row">
			<div class="col-md-4">
			</div>  
			<label class="detail">Blood Group: </label>
			<label class="detail"><?=$row['pat_bloodGroup']?></label>
			</div>
		<?php }?>
			...
			<a class="aButton" href="editProfilePatient.php">Edit Information</a>
			</div>			
