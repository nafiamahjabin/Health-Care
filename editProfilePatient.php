...
$s = " select * from tbl_patient where pat_username = '$username'";

$result = mysqli_query($con, $s);
while($row = mysqli_fetch_array($result))
{
    $firstName= $row['pat_FirstName'];
    $lastName= $row['pat_LastName'];
    $address= $row['pat_address'];
    $mobile= $row['pat_mobile'];
    $lastDonation= $row['pat_birthDate'];
    $bloodGroup= $row['pat_bloodGroup'];
    $pass= $row['pat_password'];
    $email= $row['pat_email'];
}
...
<div class="modal fade" id="doctorModalSignup" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
 ...
 <div class="container">
   ...
   <form action="updatePatient.php" method="post">
          <div class="form-group">
            <label>First Name</label>
            <input type="text" name="first" class="form-control" value="<?=$firstName ?>" required>  
            </div>                           
            <div class="form-group">
            <label>Last Name</label>
            ...
            <div class="form-group">
            <label>Password</label>
            <input type="password" name="password" class="form-control" value="<?=$pass ?>" required>  
            </div>
            
            <div class="form-group">
            <div class="bloodcolor">
            <label>Blood Group</label>
              <h6><?=$bloodGroup ?></h6>    
            </div>
            </div>
            <div class="form-group">
            <label>Birth Date</label>
            <input type="date" name="bday" class="form-control"  value="<?=$lastDonation ?>" required>  
            </div>
            <div class="form-group">
            <label>Mobile No.</label>
