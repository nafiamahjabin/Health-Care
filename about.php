...
<div class="modal fade" id="doctorModalSignup" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
 ...
 <form action="registrationForDoctor.php" method="post">
    ...
    <p>Our main target is to reduce your harassment in taking appointment for Doctor and making your health more safe. <br /> <br /><b>Developer's information:</b> <br /> <b>Name:</b> <br /> <b>Nafia Mahjabin Sumaiya</b> <br /> It is developed <br /> in her 3rd year course <br /> for academic purpose.
    </p>
	</div>
	</div>
    <!--End of content area-->
