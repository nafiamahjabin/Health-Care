...
if(!isset($_SESSION['pat_username'])) {
    $_SESSION['msg']='To book an appointment, you need to login as a patient first..';
    $appointment="warning.php";
...
$s = "select * from tbl_doctor Where dr_status= 'registered'";
        ...
        <div class="container">
                <div class="boxdoc">
                    <div class="row">
                        <div class="col-md-8">
                        <div class="text1">
                            <h2><?=$row['dr_FirstName']." ".$row['dr_LastName']?></h2>
                            <ul>
                            	<li>Specialist On :</br><?=$row['dr_dept']?></li>
                            	<li>Qualification :</br><?=$row['dr_degree']?></li>
                            	<li>Chamber Location :</br><?=$row['dr_chember']?></li>
                            	<li>Visiting Hours :</br><?=$row['dr_visitTime']?></li>  
                            </ul>
                            </div>
                            ...
                            <div class="icon1">
                            <ul>
                            	<li>FEES :</br><?=$row['dr_firstFee']?>TK (First Visit), <?=$row['dr_secondFee']?>TK (Second Visit within a month)</li>
                            	<li>ASSISTANT NAME :</br><?=$row['dr_conName']?></li>
                            	<li>ASSISTANT'S MOBILE NO.(For Contact) :</br><?=$row['dr_conMobile']?></li>
                            </ul> 
                        </div>
				...
				<form action="<?=$appointment?>" method="post">
                        <button type="submit" name="dr_username" value="<?=$row['dr_username']?>" class="btn btn-primary">BOOK A APPOINTMENT</button>
                        </form>
				  </div>
