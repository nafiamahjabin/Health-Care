...
<div class="modal fade" id="doctorModalSignup" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
 ...
 <form action="registrationForDoctor.php" method="post">
	...
	<?php 
		...
		<h1 class="text-center">Confirm Appointment</h1>
		</div>
                <div class="boxdoc">
                    <div class="row">
                        <div class="col-md-8">
						...
						<div class="confirmForm"><form  action="confirmApp.php" method="post">
                              <input type="hidden" name="dr_username" value="<?=$dr_username?>">
                             <div class="form-group">
                                    <label >Date</label>
